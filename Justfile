...
# Run all tests
test:
    go test ./... ./bridge/cobra/... ./bridge/urfave/...
...
coverage:
    ...
    go test -coverprofile="$coverage_file" ./... ./bridge/cobra/... ./bridge/urfave/...
...
lint:
    golangci-lint run
    golangci-lint run ./bridge/cobra/...
    golangci-lint run ./bridge/urfave/...
...
build:
    go build ./... ./bridge/cobra/... ./bridge/urfave/...
